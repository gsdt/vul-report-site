...
<div class="container">
    ...
    <div class="row h-100">
        <div class="col-sm-12 my-auto">
            <div class="container">
                <form class="form-horizontal" autocomplete="off" role="form" method="POST" action="profile?action=update&id=<?php echo $this->user->id ?>">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" disabled class="form-control" id="username" value=<?php  echo '"'.htmlspecialchars($this->user->username,ENT_QUOTES).'"'?> >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="role" class="col-sm-4 col-form-label">Role</label>
                                <div class="col-sm-8">
                                    <input type="text" disabled class="form-control" id="role" value=<?php  echo '"'.htmlspecialchars($this->user->roles,ENT_QUOTES).'"'?> >
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="old-password" class="col-sm-4 col-form-label">Current password</label>
                                <div class="col-sm-8">
                                    <input type="password" class="form-control" id="old-password" name="oldpassword" placeholder="Current password">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="email" class="form-control" id="email" name ="email" value=<?php  echo htmlspecialchars($this->user->email,ENT_QUOTES)?>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLongTitle">Delete account confirm</h5>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">&times;</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            Do you really want to delete this account? <br> Deletion can not be recovered!
                                        </div>
