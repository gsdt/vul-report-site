        ...
        <div class="col-sm-12 my-auto">
            <div class="container">
                <form class="form-horizontal" autocomplete="off" role="form" method="POST"
                      action="reset?action=reset&token=<?php echo $this->reseter->token ?>">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                    <input type="text" disabled class="form-control" id="username"
                                           value=<?php echo '"' . htmlspecialchars($this->reseter->username, ENT_QUOTES) . '"' ?>>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <input type="hidden" name="validator"
                                   value= <?php echo '"' . $this->reseter->validator . '"' ?>/>
                        </div>
                    </div>
                    ...
                    <div class="row" style="padding-top: 1rem">
                        <div class="col-md-3"></div>
                        <div class="col-md-6">
                            <button type="submit" class="btn btn-success"><i class="fa fa-edit"></i> Change password
                            </button>
                        </div>
                    </div>
                </form>
