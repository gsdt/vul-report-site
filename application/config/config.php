...
define('DB_NAME', 'ReportDB');
define('DB_USER', 'gsdt');
define('DB_PASS', 'gsdt');
define('DB_CHARSET', 'utf8');

/**
 * Configure for reCAPTCHA
 */
define('PUBLIC_KEY', '6LcgfGkUAAAAAPChtbGX_4UVd7gMS2-mOvkZysg5');
define('PRIVATE_KEY', '6LcgfGkUAAAAAH_6mFduUe0fFBQl42cNTq84S9W0');